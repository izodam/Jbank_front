...
export const useBankStore = defineStore(
  ...
  () => {
    ...
    const findDetail = function (fin_prdt_cd) {
      axios({
        method: "get",
        url: `${API_URL}/savings/deposit-options/${fin_prdt_cd}/`,
        headers: {
          Authorization: "Token 42307ee34a9f73065db26bcc9b95775673d6f200",
        },
      })
        .then((response) => {
    ...
    const findSavingDetail = function (fin_prdt_cd) {
      axios({
        method: "get",
    ...
    const findFreeSavingDetail = function (fin_prdt_cd) {
      axios({
        method: "get",
