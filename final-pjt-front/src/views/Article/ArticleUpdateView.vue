...
const title = ref(store.articleDetail.article.title);
console.log(store.articleDetail.article.title);
const content = ref(store.articleDetail.article.content);
