...
- 김준호 : 이번 프로젝트를 통해 금융 관련 웹 애플리케이션을 개발하면서 다양한 API를 연동하고, 사용자에게 유용한 정보를 제공하는 방법을 배울 수 있었습니다. 특히, 금융 상품 추천 알고리즘을 구현하면서 데이터 분석과 머신러닝에 대한 이해를 높일 수 있었습니다. 팀원들과의 협업을 통해 프로젝트를 성공적으로 완료할 수 있었으며, 앞으로도 다양한 프로젝트에 도전하고 싶습니다.
